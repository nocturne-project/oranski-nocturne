...
export const meta = {
	...
	res: {
		...
		properties: {
			...
			topicListSpring: { type: 'string', optional: false, nullable: false },
			topicListSummer: { type: 'string', optional: false, nullable: false },
			topicListAutumn: { type: 'string', optional: false, nullable: false },
			topicListWinter: { type: 'string', optional: false, nullable: false },
