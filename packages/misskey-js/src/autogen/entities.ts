...
export type AdminFederationRemoveAllFollowingByUserIdRequest = operations['admin___federation___remove-all-following-by-user-id']['requestBody']['content']['application/json'];
...
export type AdminNoctownGachaAddItemRequest = operations['admin___noctown___gacha___add-item']['requestBody']['content']['application/json'];
export type AdminNoctownGachaAddItemResponse = operations['admin___noctown___gacha___add-item']['responses']['200']['content']['application/json'];
export type AdminNoctownGachaCreateRequest = operations['admin___noctown___gacha___create']['requestBody']['content']['application/json'];
export type AdminNoctownGachaCreateResponse = operations['admin___noctown___gacha___create']['responses']['200']['content']['application/json'];
export type AdminNoctownGachaDeleteRequest = operations['admin___noctown___gacha___delete']['requestBody']['content']['application/json'];
export type AdminNoctownGachaItemsRequest = operations['admin___noctown___gacha___items']['requestBody']['content']['application/json'];
export type AdminNoctownGachaItemsResponse = operations['admin___noctown___gacha___items']['responses']['200']['content']['application/json'];
export type AdminNoctownGachaListRequest = operations['admin___noctown___gacha___list']['requestBody']['content']['application/json'];
export type AdminNoctownGachaListResponse = operations['admin___noctown___gacha___list']['responses']['200']['content']['application/json'];
export type AdminNoctownGachaRemoveItemRequest = operations['admin___noctown___gacha___remove-item']['requestBody']['content']['application/json'];
export type AdminNoctownGachaUpdateRequest = operations['admin___noctown___gacha___update']['requestBody']['content']['application/json'];
export type AdminNoqDiscloseRequest = operations['admin___noq___disclose']['requestBody']['content']['application/json'];
export type AdminNoqDiscloseResponse = operations['admin___noq___disclose']['responses']['200']['content']['application/json'];
export type AdminNoqSettingsResponse = operations['admin___noq___settings']['responses']['200']['content']['application/json'];
export type AdminNoqSettingsUpdateRequest = operations['admin___noq___settings___update']['requestBody']['content']['application/json'];
export type AdminNoqSettingsUpdateResponse = operations['admin___noq___settings___update']['responses']['200']['content']['application/json'];
export type AdminPaintChatSettingsResponse = operations['admin___paint-chat___settings']['responses']['200']['content']['application/json'];
export type AdminPaintChatSettingsUpdateRequest = operations['admin___paint-chat___settings___update']['requestBody']['content']['application/json'];
export type AdminPaintChatSettingsUpdateResponse = operations['admin___paint-chat___settings___update']['responses']['200']['content']['application/json'];
export type AdminPaintChatStegoExtractRequest = operations['admin___paint-chat___stego___extract']['requestBody']['content']['application/json'];
export type AdminPaintChatStegoExtractResponse = operations['admin___paint-chat___stego___extract']['responses']['200']['content']['application/json'];
...
export type AdminUpdateUserSuspendedReasonRequest = operations['admin___update-user-suspended-reason']['requestBody']['content']['application/json'];
...
export type ChatGetSecretModeForUserRequest = operations['chat___get-secret-mode-for-user']['requestBody']['content']['application/json'];
...
export type ChatMessagesReadRequest = operations['chat___messages___read']['requestBody']['content']['application/json'];
export type ChatMessagesReadUsersRequest = operations['chat___messages___read-users']['requestBody']['content']['application/json'];
export type ChatMessagesReadUsersResponse = operations['chat___messages___read-users']['responses']['200']['content']['application/json'];
...
export type ChatRoomsGetSecretModeRequest = operations['chat___rooms___get-secret-mode']['requestBody']['content']['application/json'];
export type ChatRoomsGetSecretModeResponse = operations['chat___rooms___get-secret-mode']['responses']['200']['content']['application/json'];
...
export type ChatRoomsSetSecretModeRequest = operations['chat___rooms___set-secret-mode']['requestBody']['content']['application/json'];
...
export type ChatSetSecretModeForUserRequest = operations['chat___set-secret-mode-for-user']['requestBody']['content']['application/json'];
...
export type DrawingCanvasRequest = operations['drawing___canvas']['requestBody']['content']['application/json'];
export type DrawingCanvasResponse = operations['drawing___canvas']['responses']['200']['content']['application/json'];
export type DrawingSaveRequest = operations['drawing___save']['requestBody']['content']['application/json'];
export type DrawingSettingsRoomGetRequest = operations['drawing___settings___room___get']['requestBody']['content']['application/json'];
export type DrawingSettingsRoomGetResponse = operations['drawing___settings___room___get']['responses']['200']['content']['application/json'];
export type DrawingSettingsRoomUpdateRequest = operations['drawing___settings___room___update']['requestBody']['content']['application/json'];
export type DrawingSettingsUserGetRequest = operations['drawing___settings___user___get']['requestBody']['content']['application/json'];
export type DrawingSettingsUserGetResponse = operations['drawing___settings___user___get']['responses']['200']['content']['application/json'];
export type DrawingSettingsUserUpdateRequest = operations['drawing___settings___user___update']['requestBody']['content']['application/json'];
...
export type DriveFilesToggleIllustrationHighlightExclusionRequest = operations['drive___files___toggle-illustration-highlight-exclusion']['requestBody']['content']['application/json'];
...
export type HashtagsIllustrationRequest = operations['hashtags___illustration']['requestBody']['content']['application/json'];
export type HashtagsIllustrationResponse = operations['hashtags___illustration']['responses']['200']['content']['application/json'];
...
export type NoctownAdminItemCreateRequest = operations['noctown___admin___item___create']['requestBody']['content']['application/json'];
export type NoctownAdminItemCreateResponse = operations['noctown___admin___item___create']['responses']['200']['content']['application/json'];
export type NoctownAdminItemDistributeRequest = operations['noctown___admin___item___distribute']['requestBody']['content']['application/json'];
export type NoctownAdminItemDistributeResponse = operations['noctown___admin___item___distribute']['responses']['200']['content']['application/json'];
export type NoctownAgentEquipRequest = operations['noctown___agent___equip']['requestBody']['content']['application/json'];
export type NoctownAgentEquipResponse = operations['noctown___agent___equip']['responses']['200']['content']['application/json'];
export type NoctownAgentFeedRequest = operations['noctown___agent___feed']['requestBody']['content']['application/json'];
export type NoctownAgentFeedResponse = operations['noctown___agent___feed']['responses']['200']['content']['application/json'];
export type NoctownAgentHintRequest = operations['noctown___agent___hint']['requestBody']['content']['application/json'];
export type NoctownAgentHintResponse = operations['noctown___agent___hint']['responses']['200']['content']['application/json'];
export type NoctownAgentListResponse = operations['noctown___agent___list']['responses']['200']['content']['application/json'];
export type NoctownBulletinAttachItemRequest = operations['noctown___bulletin___attach-item']['requestBody']['content']['application/json'];
export type NoctownBulletinAttachItemResponse = operations['noctown___bulletin___attach-item']['responses']['200']['content']['application/json'];
export type NoctownBulletinBoardsRequest = operations['noctown___bulletin___boards']['requestBody']['content']['application/json'];
export type NoctownBulletinBoardsResponse = operations['noctown___bulletin___boards']['responses']['200']['content']['application/json'];
export type NoctownBulletinCreatePostRequest = operations['noctown___bulletin___create-post']['requestBody']['content']['application/json'];
export type NoctownBulletinCreatePostResponse = operations['noctown___bulletin___create-post']['responses']['200']['content']['application/json'];
export type NoctownBulletinDeletePostRequest = operations['noctown___bulletin___delete-post']['requestBody']['content']['application/json'];
export type NoctownBulletinLikeRequest = operations['noctown___bulletin___like']['requestBody']['content']['application/json'];
export type NoctownBulletinLikeResponse = operations['noctown___bulletin___like']['responses']['200']['content']['application/json'];
export type NoctownBulletinPostsRequest = operations['noctown___bulletin___posts']['requestBody']['content']['application/json'];
export type NoctownBulletinPostsResponse = operations['noctown___bulletin___posts']['responses']['200']['content']['application/json'];
export type NoctownBulletinUnlikeRequest = operations['noctown___bulletin___unlike']['requestBody']['content']['application/json'];
export type NoctownBulletinUnlikeResponse = operations['noctown___bulletin___unlike']['responses']['200']['content']['application/json'];
export type NoctownChatHistoryRequest = operations['noctown___chat-history']['requestBody']['content']['application/json'];
export type NoctownChatHistoryResponse = operations['noctown___chat-history']['responses']['200']['content']['application/json'];
export type NoctownChatLogReceiveRequest = operations['noctown___chat-log___receive']['requestBody']['content']['application/json'];
export type NoctownChatLogReceiveResponse = operations['noctown___chat-log___receive']['responses']['200']['content']['application/json'];
export type NoctownChestOpenRequest = operations['noctown___chest___open']['requestBody']['content']['application/json'];
export type NoctownChestOpenResponse = operations['noctown___chest___open']['responses']['200']['content']['application/json'];
export type NoctownChickenCollectEggsRequest = operations['noctown___chicken___collect-eggs']['requestBody']['content']['application/json'];
export type NoctownChickenCollectEggsResponse = operations['noctown___chicken___collect-eggs']['responses']['200']['content']['application/json'];
export type NoctownChickenFeedRequest = operations['noctown___chicken___feed']['requestBody']['content']['application/json'];
export type NoctownChickenFeedResponse = operations['noctown___chicken___feed']['responses']['200']['content']['application/json'];
export type NoctownChickenListResponse = operations['noctown___chicken___list']['responses']['200']['content']['application/json'];
export type NoctownChickenPlaceRequest = operations['noctown___chicken___place']['requestBody']['content']['application/json'];
export type NoctownChickenPlaceResponse = operations['noctown___chicken___place']['responses']['200']['content']['application/json'];
export type NoctownContainerOpenRequest = operations['noctown___container___open']['requestBody']['content']['application/json'];
export type NoctownContainerOpenResponse = operations['noctown___container___open']['responses']['200']['content']['application/json'];
export type NoctownContainerOpenPlacedRequest = operations['noctown___container___open-placed']['requestBody']['content']['application/json'];
export type NoctownContainerOpenPlacedResponse = operations['noctown___container___open-placed']['responses']['200']['content']['application/json'];
export type NoctownContainerSetItemsRequest = operations['noctown___container___set-items']['requestBody']['content']['application/json'];
export type NoctownContainerSetItemsResponse = operations['noctown___container___set-items']['responses']['200']['content']['application/json'];
export type NoctownCowCollectMilkRequest = operations['noctown___cow___collect-milk']['requestBody']['content']['application/json'];
export type NoctownCowCollectMilkResponse = operations['noctown___cow___collect-milk']['responses']['200']['content']['application/json'];
export type NoctownCowFeedRequest = operations['noctown___cow___feed']['requestBody']['content']['application/json'];
export type NoctownCowFeedResponse = operations['noctown___cow___feed']['responses']['200']['content']['application/json'];
export type NoctownCowListResponse = operations['noctown___cow___list']['responses']['200']['content']['application/json'];
export type NoctownCowPlaceRequest = operations['noctown___cow___place']['requestBody']['content']['application/json'];
export type NoctownCowPlaceResponse = operations['noctown___cow___place']['responses']['200']['content']['application/json'];
export type NoctownCraftExecuteRequest = operations['noctown___craft___execute']['requestBody']['content']['application/json'];
export type NoctownCraftExecuteResponse = operations['noctown___craft___execute']['responses']['200']['content']['application/json'];
export type NoctownCraftRecipesRequest = operations['noctown___craft___recipes']['requestBody']['content']['application/json'];
export type NoctownCraftRecipesResponse = operations['noctown___craft___recipes']['responses']['200']['content']['application/json'];
export type NoctownEventClaimRewardRequest = operations['noctown___event___claim-reward']['requestBody']['content']['application/json'];
export type NoctownEventClaimRewardResponse = operations['noctown___event___claim-reward']['responses']['200']['content']['application/json'];
export type NoctownEventJoinRequest = operations['noctown___event___join']['requestBody']['content']['application/json'];
export type NoctownEventListRequest = operations['noctown___event___list']['requestBody']['content']['application/json'];
export type NoctownEventListResponse = operations['noctown___event___list']['responses']['200']['content']['application/json'];
export type NoctownEventProgressRequest = operations['noctown___event___progress']['requestBody']['content']['application/json'];
export type NoctownEventProgressResponse = operations['noctown___event___progress']['responses']['200']['content']['application/json'];
export type NoctownFarmCreateRequest = operations['noctown___farm___create']['requestBody']['content']['application/json'];
export type NoctownFarmCreateResponse = operations['noctown___farm___create']['responses']['200']['content']['application/json'];
export type NoctownFarmHarvestRequest = operations['noctown___farm___harvest']['requestBody']['content']['application/json'];
export type NoctownFarmHarvestResponse = operations['noctown___farm___harvest']['responses']['200']['content']['application/json'];
export type NoctownFarmListResponse = operations['noctown___farm___list']['responses']['200']['content']['application/json'];
export type NoctownFarmPlantRequest = operations['noctown___farm___plant']['requestBody']['content']['application/json'];
export type NoctownFarmPlantResponse = operations['noctown___farm___plant']['responses']['200']['content']['application/json'];
export type NoctownFarmWaterRequest = operations['noctown___farm___water']['requestBody']['content']['application/json'];
export type NoctownFarmWaterResponse = operations['noctown___farm___water']['responses']['200']['content']['application/json'];
export type NoctownFishingCastRequest = operations['noctown___fishing___cast']['requestBody']['content']['application/json'];
export type NoctownFishingCastResponse = operations['noctown___fishing___cast']['responses']['200']['content']['application/json'];
export type NoctownFishingCatchResponse = operations['noctown___fishing___catch']['responses']['200']['content']['application/json'];
export type NoctownGachaListResponse = operations['noctown___gacha___list']['responses']['200']['content']['application/json'];
export type NoctownGachaPullRequest = operations['noctown___gacha___pull']['requestBody']['content']['application/json'];
export type NoctownGachaPullResponse = operations['noctown___gacha___pull']['responses']['200']['content']['application/json'];
export type NoctownHarvestWoodRequest = operations['noctown___harvest___wood']['requestBody']['content']['application/json'];
export type NoctownHarvestWoodResponse = operations['noctown___harvest___wood']['responses']['200']['content']['application/json'];
export type NoctownHouseEnterRequest = operations['noctown___house___enter']['requestBody']['content']['application/json'];
export type NoctownHouseEnterResponse = operations['noctown___house___enter']['responses']['200']['content']['application/json'];
export type NoctownHouseExitRequest = operations['noctown___house___exit']['requestBody']['content']['application/json'];
export type NoctownHouseExitResponse = operations['noctown___house___exit']['responses']['200']['content']['application/json'];
export type NoctownHouseFurnitureListRequest = operations['noctown___house___furniture___list']['requestBody']['content']['application/json'];
export type NoctownHouseFurnitureListResponse = operations['noctown___house___furniture___list']['responses']['200']['content']['application/json'];
export type NoctownHouseFurnitureMoveRequest = operations['noctown___house___furniture___move']['requestBody']['content']['application/json'];
export type NoctownHouseFurnitureMoveResponse = operations['noctown___house___furniture___move']['responses']['200']['content']['application/json'];
export type NoctownHouseFurniturePlaceRequest = operations['noctown___house___furniture___place']['requestBody']['content']['application/json'];
export type NoctownHouseFurniturePlaceResponse = operations['noctown___house___furniture___place']['responses']['200']['content']['application/json'];
export type NoctownHouseFurnitureRemoveRequest = operations['noctown___house___furniture___remove']['requestBody']['content']['application/json'];
export type NoctownHouseFurnitureRemoveResponse = operations['noctown___house___furniture___remove']['responses']['200']['content']['application/json'];
export type NoctownHouseGetResponse = operations['noctown___house___get']['responses']['200']['content']['application/json'];
export type NoctownHouseNearbyRequest = operations['noctown___house___nearby']['requestBody']['content']['application/json'];
export type NoctownHouseNearbyResponse = operations['noctown___house___nearby']['responses']['200']['content']['application/json'];
export type NoctownHousePlaceRequest = operations['noctown___house___place']['requestBody']['content']['application/json'];
export type NoctownHousePlaceResponse = operations['noctown___house___place']['responses']['200']['content']['application/json'];
export type NoctownHouseRemoveRequest = operations['noctown___house___remove']['requestBody']['content']['application/json'];
export type NoctownHouseRemoveResponse = operations['noctown___house___remove']['responses']['200']['content']['application/json'];
export type NoctownHouseRenameRequest = operations['noctown___house___rename']['requestBody']['content']['application/json'];
export type NoctownHouseRenameResponse = operations['noctown___house___rename']['responses']['200']['content']['application/json'];
export type NoctownHouseWallAttachRequest = operations['noctown___house___wall___attach']['requestBody']['content']['application/json'];
export type NoctownHouseWallAttachResponse = operations['noctown___house___wall___attach']['responses']['200']['content']['application/json'];
export type NoctownHouseWallListRequest = operations['noctown___house___wall___list']['requestBody']['content']['application/json'];
export type NoctownHouseWallListResponse = operations['noctown___house___wall___list']['responses']['200']['content']['application/json'];
export type NoctownHouseWallRemoveRequest = operations['noctown___house___wall___remove']['requestBody']['content']['application/json'];
export type NoctownHouseWallRemoveResponse = operations['noctown___house___wall___remove']['responses']['200']['content']['application/json'];
export type NoctownHouseWallSetRequest = operations['noctown___house___wall___set']['requestBody']['content']['application/json'];
export type NoctownHouseWallSetResponse = operations['noctown___house___wall___set']['responses']['200']['content']['application/json'];
export type NoctownItemCreateRequest = operations['noctown___item___create']['requestBody']['content']['application/json'];
export type NoctownItemCreateResponse = operations['noctown___item___create']['responses']['200']['content']['application/json'];
export type NoctownItemDetailRequest = operations['noctown___item___detail']['requestBody']['content']['application/json'];
export type NoctownItemDetailResponse = operations['noctown___item___detail']['responses']['200']['content']['application/json'];
export type NoctownItemDropRequest = operations['noctown___item___drop']['requestBody']['content']['application/json'];
export type NoctownItemDropResponse = operations['noctown___item___drop']['responses']['200']['content']['application/json'];
export type NoctownItemDropCurrencyRequest = operations['noctown___item___drop-currency']['requestBody']['content']['application/json'];
export type NoctownItemDropCurrencyResponse = operations['noctown___item___drop-currency']['responses']['200']['content']['application/json'];
export type NoctownItemDroppedRequest = operations['noctown___item___dropped']['requestBody']['content']['application/json'];
export type NoctownItemDroppedResponse = operations['noctown___item___dropped']['responses']['200']['content']['application/json'];
export type NoctownItemInventoryResponse = operations['noctown___item___inventory']['responses']['200']['content']['application/json'];
export type NoctownItemMyCreationsRequest = operations['noctown___item___my-creations']['requestBody']['content']['application/json'];
export type NoctownItemMyCreationsResponse = operations['noctown___item___my-creations']['responses']['200']['content']['application/json'];
export type NoctownItemPickupRequest = operations['noctown___item___pickup']['requestBody']['content']['application/json'];
export type NoctownItemPickupResponse = operations['noctown___item___pickup']['responses']['200']['content']['application/json'];
export type NoctownItemPickupPlacedRequest = operations['noctown___item___pickup-placed']['requestBody']['content']['application/json'];
export type NoctownItemPickupPlacedResponse = operations['noctown___item___pickup-placed']['responses']['200']['content']['application/json'];
export type NoctownItemPlaceRequest = operations['noctown___item___place']['requestBody']['content']['application/json'];
export type NoctownItemPlaceResponse = operations['noctown___item___place']['responses']['200']['content']['application/json'];
export type NoctownItemPlacedRequest = operations['noctown___item___placed']['requestBody']['content']['application/json'];
export type NoctownItemPlacedResponse = operations['noctown___item___placed']['responses']['200']['content']['application/json'];
export type NoctownItemRetrieveRequest = operations['noctown___item___retrieve']['requestBody']['content']['application/json'];
export type NoctownItemRetrieveResponse = operations['noctown___item___retrieve']['responses']['200']['content']['application/json'];
export type NoctownItemUpdateCreationRequest = operations['noctown___item___update-creation']['requestBody']['content']['application/json'];
export type NoctownMapChunkRequest = operations['noctown___map___chunk']['requestBody']['content']['application/json'];
export type NoctownMapChunkResponse = operations['noctown___map___chunk']['responses']['200']['content']['application/json'];
export type NoctownNpcNearbyRequest = operations['noctown___npc___nearby']['requestBody']['content']['application/json'];
export type NoctownNpcNearbyResponse = operations['noctown___npc___nearby']['responses']['200']['content']['application/json'];
export type NoctownPetsCreateRequest = operations['noctown___pets___create']['requestBody']['content']['application/json'];
export type NoctownPetsCreateResponse = operations['noctown___pets___create']['responses']['200']['content']['application/json'];
export type NoctownPetsDeleteRequest = operations['noctown___pets___delete']['requestBody']['content']['application/json'];
export type NoctownPetsDeleteResponse = operations['noctown___pets___delete']['responses']['200']['content']['application/json'];
export type NoctownPetsListResponse = operations['noctown___pets___list']['responses']['200']['content']['application/json'];
export type NoctownPetsNearbyRequest = operations['noctown___pets___nearby']['requestBody']['content']['application/json'];
export type NoctownPetsNearbyResponse = operations['noctown___pets___nearby']['responses']['200']['content']['application/json'];
export type NoctownPetsRenameRequest = operations['noctown___pets___rename']['requestBody']['content']['application/json'];
export type NoctownPetsRenameResponse = operations['noctown___pets___rename']['responses']['200']['content']['application/json'];
export type NoctownPetsShowRequest = operations['noctown___pets___show']['requestBody']['content']['application/json'];
export type NoctownPetsShowResponse = operations['noctown___pets___show']['responses']['200']['content']['application/json'];
export type NoctownPlayerResponse = operations['noctown___player']['responses']['200']['content']['application/json'];
export type NoctownPlayerEquipSkinRequest = operations['noctown___player___equip-skin']['requestBody']['content']['application/json'];
export type NoctownPlayerEquipSkinResponse = operations['noctown___player___equip-skin']['responses']['200']['content']['application/json'];
export type NoctownPlayerPositionRequest = operations['noctown___player___position']['requestBody']['content']['application/json'];
export type NoctownPlayerPositionResponse = operations['noctown___player___position']['responses']['200']['content']['application/json'];
export type NoctownPlayerUnequipSkinResponse = operations['noctown___player___unequip-skin']['responses']['200']['content']['application/json'];
export type NoctownPlayersNearbyRequest = operations['noctown___players___nearby']['requestBody']['content']['application/json'];
export type NoctownPlayersNearbyResponse = operations['noctown___players___nearby']['responses']['200']['content']['application/json'];
export type NoctownQuestAbandonRequest = operations['noctown___quest___abandon']['requestBody']['content']['application/json'];
export type NoctownQuestAbandonResponse = operations['noctown___quest___abandon']['responses']['200']['content']['application/json'];
export type NoctownQuestCompleteRequest = operations['noctown___quest___complete']['requestBody']['content']['application/json'];
export type NoctownQuestCompleteResponse = operations['noctown___quest___complete']['responses']['200']['content']['application/json'];
export type NoctownQuestListResponse = operations['noctown___quest___list']['responses']['200']['content']['application/json'];
export type NoctownQuestStartRequest = operations['noctown___quest___start']['requestBody']['content']['application/json'];
export type NoctownQuestStartResponse = operations['noctown___quest___start']['responses']['200']['content']['application/json'];
export type NoctownRankingCategoryRequest = operations['noctown___ranking___category']['requestBody']['content']['application/json'];
export type NoctownRankingCategoryResponse = operations['noctown___ranking___category']['responses']['200']['content']['application/json'];
export type NoctownRankingTotalRequest = operations['noctown___ranking___total']['requestBody']['content']['application/json'];
export type NoctownRankingTotalResponse = operations['noctown___ranking___total']['responses']['200']['content']['application/json'];
export type NoctownSaisenHistoryRequest = operations['noctown___saisen___history']['requestBody']['content']['application/json'];
export type NoctownSaisenHistoryResponse = operations['noctown___saisen___history']['responses']['200']['content']['application/json'];
export type NoctownSaisenOfferRequest = operations['noctown___saisen___offer']['requestBody']['content']['application/json'];
export type NoctownSaisenOfferResponse = operations['noctown___saisen___offer']['responses']['200']['content']['application/json'];
export type NoctownShopBuyRequest = operations['noctown___shop___buy']['requestBody']['content']['application/json'];
export type NoctownShopBuyResponse = operations['noctown___shop___buy']['responses']['200']['content']['application/json'];
export type NoctownShopSellRequest = operations['noctown___shop___sell']['requestBody']['content']['application/json'];
export type NoctownShopSellResponse = operations['noctown___shop___sell']['responses']['200']['content']['application/json'];
export type NoctownTradeAddItemsRequest = operations['noctown___trade___add-items']['requestBody']['content']['application/json'];
export type NoctownTradeAddItemsResponse = operations['noctown___trade___add-items']['responses']['200']['content']['application/json'];
export type NoctownTradeBarterRequest = operations['noctown___trade___barter']['requestBody']['content']['application/json'];
export type NoctownTradeBarterResponse = operations['noctown___trade___barter']['responses']['200']['content']['application/json'];
export type NoctownTradeCancelRequest = operations['noctown___trade___cancel']['requestBody']['content']['application/json'];
export type NoctownTradeCancelResponse = operations['noctown___trade___cancel']['responses']['200']['content']['application/json'];
export type NoctownTradeConfirmRequest = operations['noctown___trade___confirm']['requestBody']['content']['application/json'];
export type NoctownTradeConfirmResponse = operations['noctown___trade___confirm']['responses']['200']['content']['application/json'];
export type NoctownTradeDetailRequest = operations['noctown___trade___detail']['requestBody']['content']['application/json'];
export type NoctownTradeDetailResponse = operations['noctown___trade___detail']['responses']['200']['content']['application/json'];
export type NoctownTradeExecuteRequest = operations['noctown___trade___execute']['requestBody']['content']['application/json'];
export type NoctownTradeExecuteResponse = operations['noctown___trade___execute']['responses']['200']['content']['application/json'];
export type NoctownTradeListResponse = operations['noctown___trade___list']['responses']['200']['content']['application/json'];
export type NoctownTradeRequestRequest = operations['noctown___trade___request']['requestBody']['content']['application/json'];
export type NoctownTradeRequestResponse = operations['noctown___trade___request']['responses']['200']['content']['application/json'];
export type NoctownTradeRespondRequest = operations['noctown___trade___respond']['requestBody']['content']['application/json'];
export type NoctownTradeRespondResponse = operations['noctown___trade___respond']['responses']['200']['content']['application/json'];
export type NoctownTradeUnconfirmRequest = operations['noctown___trade___unconfirm']['requestBody']['content']['application/json'];
export type NoctownTradeUnconfirmResponse = operations['noctown___trade___unconfirm']['responses']['200']['content']['application/json'];
export type NoqAnnounceRequest = operations['noq___announce']['requestBody']['content']['application/json'];
export type NoqAnnounceResponse = operations['noq___announce']['responses']['200']['content']['application/json'];
export type NoqMuteCreateRequest = operations['noq___mute___create']['requestBody']['content']['application/json'];
export type NoqMuteDeleteRequest = operations['noq___mute___delete']['requestBody']['content']['application/json'];
export type NoqMuteListResponse = operations['noq___mute___list']['responses']['200']['content']['application/json'];
export type NoqQuestionsAnswerRequest = operations['noq___questions___answer']['requestBody']['content']['application/json'];
export type NoqQuestionsAnswerResponse = operations['noq___questions___answer']['responses']['200']['content']['application/json'];
export type NoqQuestionsAnsweredRequest = operations['noq___questions___answered']['requestBody']['content']['application/json'];
export type NoqQuestionsAnsweredResponse = operations['noq___questions___answered']['responses']['200']['content']['application/json'];
export type NoqQuestionsDeleteRequest = operations['noq___questions___delete']['requestBody']['content']['application/json'];
export type NoqQuestionsReceivedRequest = operations['noq___questions___received']['requestBody']['content']['application/json'];
export type NoqQuestionsReceivedResponse = operations['noq___questions___received']['responses']['200']['content']['application/json'];
export type NoqQuestionsReportRequest = operations['noq___questions___report']['requestBody']['content']['application/json'];
export type NoqQuestionsReportResponse = operations['noq___questions___report']['responses']['200']['content']['application/json'];
export type NoqQuestionsSendRequest = operations['noq___questions___send']['requestBody']['content']['application/json'];
export type NoqQuestionsSendResponse = operations['noq___questions___send']['responses']['200']['content']['application/json'];
export type NoqQuestionsSentRequest = operations['noq___questions___sent']['requestBody']['content']['application/json'];
export type NoqQuestionsSentResponse = operations['noq___questions___sent']['responses']['200']['content']['application/json'];
export type NoqSettingsGenerateKeyRequest = operations['noq___settings___generate-key']['requestBody']['content']['application/json'];
export type NoqSettingsGenerateKeyResponse = operations['noq___settings___generate-key']['responses']['200']['content']['application/json'];
export type NoqSettingsGetResponse = operations['noq___settings___get']['responses']['200']['content']['application/json'];
export type NoqSettingsShowRequest = operations['noq___settings___show']['requestBody']['content']['application/json'];
export type NoqSettingsShowResponse = operations['noq___settings___show']['responses']['200']['content']['application/json'];
export type NoqSettingsUpdateRequest = operations['noq___settings___update']['requestBody']['content']['application/json'];
export type NoqSettingsUpdateResponse = operations['noq___settings___update']['responses']['200']['content']['application/json'];
...
export type NotesHighlightIllustrationsRequest = operations['notes___highlight-illustrations']['requestBody']['content']['application/json'];
export type NotesHighlightIllustrationsResponse = operations['notes___highlight-illustrations']['responses']['200']['content']['application/json'];
...
export type NotesIllustrationRequest = operations['notes___illustration']['requestBody']['content']['application/json'];
export type NotesIllustrationResponse = operations['notes___illustration']['responses']['200']['content']['application/json'];
export type NotesIllustrationRankingRequest = operations['notes___illustration-ranking']['requestBody']['content']['application/json'];
export type NotesIllustrationRankingResponse = operations['notes___illustration-ranking']['responses']['200']['content']['application/json'];
export type NotesIllustrationsByTagRequest = operations['notes___illustrations-by-tag']['requestBody']['content']['application/json'];
export type NotesIllustrationsByTagResponse = operations['notes___illustrations-by-tag']['responses']['200']['content']['application/json'];
export type NotesIllustrationsByTagRankingRequest = operations['notes___illustrations-by-tag-ranking']['requestBody']['content']['application/json'];
export type NotesIllustrationsByTagRankingResponse = operations['notes___illustrations-by-tag-ranking']['responses']['200']['content']['application/json'];
...
export type PaintChatCanvasRequest = operations['paint-chat___canvas']['requestBody']['content']['application/json'];
export type PaintChatCanvasResponse = operations['paint-chat___canvas']['responses']['200']['content']['application/json'];
export type PaintChatDiceRequest = operations['paint-chat___dice']['requestBody']['content']['application/json'];
export type PaintChatDiceResponse = operations['paint-chat___dice']['responses']['200']['content']['application/json'];
export type PaintChatJoinResponse = operations['paint-chat___join']['responses']['200']['content']['application/json'];
export type PaintChatLeaveRequest = operations['paint-chat___leave']['requestBody']['content']['application/json'];
export type PaintChatLeaveResponse = operations['paint-chat___leave']['responses']['200']['content']['application/json'];
export type PaintChatLeaveQueueResponse = operations['paint-chat___leave-queue']['responses']['200']['content']['application/json'];
export type PaintChatMessageRequest = operations['paint-chat___message']['requestBody']['content']['application/json'];
export type PaintChatMessageResponse = operations['paint-chat___message']['responses']['200']['content']['application/json'];
export type PaintChatMessagesRequest = operations['paint-chat___messages']['requestBody']['content']['application/json'];
export type PaintChatMessagesResponse = operations['paint-chat___messages']['responses']['200']['content']['application/json'];
export type PaintChatPublishAgreeRequest = operations['paint-chat___publish___agree']['requestBody']['content']['application/json'];
export type PaintChatPublishAgreeResponse = operations['paint-chat___publish___agree']['responses']['200']['content']['application/json'];
export type PaintChatPublishMessageRequest = operations['paint-chat___publish___message']['requestBody']['content']['application/json'];
export type PaintChatPublishMessageResponse = operations['paint-chat___publish___message']['responses']['200']['content']['application/json'];
export type PaintChatPublishMyArtRequest = operations['paint-chat___publish___my-art']['requestBody']['content']['application/json'];
export type PaintChatPublishMyArtResponse = operations['paint-chat___publish___my-art']['responses']['200']['content']['application/json'];
export type PaintChatPublishRejectRequest = operations['paint-chat___publish___reject']['requestBody']['content']['application/json'];
export type PaintChatPublishRejectResponse = operations['paint-chat___publish___reject']['responses']['200']['content']['application/json'];
export type PaintChatReportRequest = operations['paint-chat___report']['requestBody']['content']['application/json'];
export type PaintChatReportResponse = operations['paint-chat___report']['responses']['200']['content']['application/json'];
...
export type PaintChatSaveColorsRequest = operations['paint-chat___save-colors']['requestBody']['content']['application/json'];
...
export type RolesListRequest = operations['roles___list']['requestBody']['content']['application/json'];
